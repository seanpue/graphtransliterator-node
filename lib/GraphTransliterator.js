...
class GraphTransliterator {
  ...
  constructor(settings) {
    ...
    this.tokensByClass = settings.tokens_by_class
      ? settings.tokens_by_class
      : tokensByClassOf(this.tokens);
    this.tokenizerPattern = settings.tokenizer_pattern
      ? settings.tokenizerPattern
      : tokenizerPatternFrom(this.tokens);
    ...
    this.metadata = settings.metadata ? settings.metadata : {};
    this.graph = settings.graph ? settings.graph : graphFrom(this.rules);
    this.tokenizerPattern = settings.tokenizer_pattern;
